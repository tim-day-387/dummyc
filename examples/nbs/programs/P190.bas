10 PRINT "PROGRAM FILE 190: ERROR - NO SPACES BEFORE KEYWORDS."
20 PRINT "    ANSI STANDARD 3.4"
30 PRINT
40 PRINT "SECTION 190.1: ERROR - NO SPACES BEFORE KEYWORDS."
50 PRINT
60 PRINT "THIS PROGRAM TESTS TO SEE IF THE BASIC PROCESSOR ACCEPTS"
70 PRINT "PROGRAM CONTAINING KEYWORDS WHICH ARE NOT PRECEDED BY"
80 PRINT "AT LEAST ONE SPACE."
90 PRINT
